            ...
            <div className={styles.details}>
                ...
                <div className={styles.header__details}>
                    <div className={styles.details_title}>
                        <h4>{item.community.name} {propStatus(item.prop_status)}</h4>
                        <span className={styles.date}>Last update: {
                ...
                <div className={styles.body__details}>
                    <div className={styles.details_desc}>
                        <h4>Details: </h4>
                        <p> {item.community.sqft_min} sqft. - {item.community.sqft_max}  sqft. Lot size</p>
                    </div>
                    <div className={styles.details_address}>
                        <h4>Address: </h4>
                        <p> {item.address.neighborhood_name && item.address.neighborhood_name + ", "}
                            {item.address.line} 
                        </p>
                    </div>
                </div>
